...
const BrandSections = () => {
    return (
        <section className="py-[5.5em]">
            <h1 className="text-[3.7em] leading-[0.95em] tracking-[-0.05em] font-semibold ml-10 mb-12 ">
                    ...
                    {logos.map((logo, index) => (
                        <SwiperSlide key={index} className="flex ">
                            <img 
                                ...
                                className="h-66 w-auto rounded-xl border-[1.5px] border-[#16161659] transition-all duration-300"
                            />
                        </SwiperSlide>
                    ))}
                </Swiper>
